...
const initFlags = () => {
	...
	['disable-features', 'ForcePreferredIntervalForVideo', config.get('unlimitedFPS', true)],
	...
	['disable-features', 'FontPreloadingDelaysRendering', config.get('unlimitedFPS', true)],
	['disable-features', 'CompositeCrossOriginIframes', config.get('unlimitedFPS', true)],
